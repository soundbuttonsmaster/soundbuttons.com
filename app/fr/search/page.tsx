...
export const metadata = buildLocaleMetadata("fr", "search")
...
export default async function FrSearchPage({ searchParams }: { searchParams: Promise<{ q?: string }> }) {
  ...
  const searchSchema = { "@context": "https://schema.org", "@type": "WebPage", name: "Rechercher Sound Buttons", url: `${BASE}/search`, isPartOf: { "@type": "WebSite", name: "SoundButtons.com", url: `${BASE}/` } }
