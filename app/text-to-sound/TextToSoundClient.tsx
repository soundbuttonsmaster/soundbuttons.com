...
export default function TextToSoundClient() {
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-blue-100 via-purple-100 to-pink-200 dark:from-blue-950 dark:via-purple-950 dark:to-pink-950 flex items-center justify-center relative py-12 px-4">
      <main className="flex-1 flex flex-col items-center justify-center max-w-md w-full">
        <div className="w-full bg-background/90 backdrop-blur rounded-3xl shadow-2xl border p-8">
          <div className="flex flex-col items-center gap-4 mb-6">
            ...
            <h1 className="text-2xl font-bold text-center text-foreground">
              Text to Sound Button
            </h1>
            <p className="text-sm text-center text-muted-foreground">
              Convert text to speech and create a custom sound button. Type your text, customize the
              voice, and generate a sound button!
            </p>
          </div>
          ...
          <p className="mt-6 text-xs text-center text-muted-foreground">
            ...
            and{" "}
            <Link href="/create-sound" className="text-primary underline hover:opacity-80">
              create sound
            </Link>{" "}
            from recording.
          </p>
